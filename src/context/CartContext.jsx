...
export const CartProvider = ({ children }) => {
  ...
  const addItemToCart = (product, selectedQuantity) => {
    ...
    // Verifica si la cantidad seleccionada no excede el stock
    ...
    setCart((prevCart) => {
      ...
      if (productIndex === -1) {
        ...
        const updatedCart = [...prevCart];
        updatedCart[productIndex].quantity += selectedQuantity;  // Aumentar la cantidad del producto en el carrito
        return updatedCart;
      }
    });
  };
